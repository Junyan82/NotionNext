...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'The Golden Sunshine', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Spreading Light Through Tales', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-dusky-iota.vercel.app', // 网站地址
